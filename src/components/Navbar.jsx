...
const Navbar = () => {
  ...
  return (
    <nav className="bg-orange-500 text-white p-4 ">
      ...
      <Link to="/" className="text-2xl font-bold ml-2 md:ml-140">🍽️ YummyHub</Link>
     <button onClick={() => setShowMenu(!showMenu)} className="md:hidden text-blue-600 font-bold text-sm underline ">
          {showMenu ? "Close" : "Menu"}
        </button>
      </div>      
     <div
